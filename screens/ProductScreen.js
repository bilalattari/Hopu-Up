  ...
  render () {
    ...
    return (
      <ScrollView stickyHeaderIndices={[0]}>
        <CustomHeader home title={'Manage Product'}
        ...
        <View style={{ marginVertical: 26 ,flexDirection : 'row' , justifyContent : 'space-around' , marginHorizontal : '8%'}}>
          <CustomButton title={'Repost'} />
